  ...
  return (
    ...
    >
      ...
      <div className="bg-[#051d40] text-white rounded-3xl p-8 relative overflow-hidden shadow-xl">
        ...
        <div className="absolute top-0 right-0 w-40 h-40 bg-accent/10 rounded-md blur-2xl -mr-10 -mt-10"></div>
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/80 text-sm leading-relaxed mb-6">
            Get curated academic strategies and technical insights delivered to
      ...
      <div className="bg-white border border-slate-200 rounded-3xl p-8 text-center shadow-sm">
        <div className="w-12 h-12 mx-auto bg-amber-50 rounded-md flex items-center justify-center mb-4">
        ...
        <p className="text-sm text-slate-600 mb-6 leading-relaxed">
          Get exclusive access to premium mock tests and 1-on-1 mentorship
          sessions.
        </p>
        <Button
          variant="link"
          className="text-primary font-bold hover:text-primary/80 decoration-2 underline underline-offset-4"
        >
          Join SuperNova Club
        </Button>
      </div>
