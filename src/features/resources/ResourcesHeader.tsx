    ...
    <div className="w-full bg-slate-50 border-b border-slate-200">
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        <p className="text-slate-600 mb-8 max-w-2xl font-sans">
          Expert insights for your academic journey. Explore our curated intelligence.
        </p>
        ...
        <div className="max-w-2xl">
          ...
          <div className="flex overflow-x-auto pb-2 scrollbar-hide space-x-3">
            <Button className="rounded-full px-6 whitespace-nowrap bg-primary text-white hover:bg-primary/90 font-semibold shadow-sm">
              All Resources
            </Button>
            <Button variant="outline" className="rounded-full px-6 whitespace-nowrap border-slate-300 text-slate-700 bg-white hover:bg-slate-100 font-semibold">
              Exam Prep
            </Button>
            <Button variant="outline" className="rounded-full px-6 whitespace-nowrap border-slate-300 text-slate-700 bg-white hover:bg-slate-100 font-semibold">
              Study Tips
