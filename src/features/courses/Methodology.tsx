          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card className="border-none shadow-sm hover:shadow-md bg-white text-center rounded-2xl">
              <CardContent className="pt-8 pb-6 px-4">
                <div className="w-16 h-16 mx-auto bg-purple-100 rounded-md flex items-center justify-center mb-4 relative">
                  <div className="absolute -top-2 bg-purple-600 text-white text-[10px] uppercase font-bold px-2 py-0.5 rounded-md">
                    Level 1
                  </div>
                  <StarIcon className="w-8 h-8 text-purple-600" />
                </div>
                <h4 className="font-bold text-slate-800 font-heading mb-2">
                  Stellar Nebula
                </h4>
            ...
            <Card className="border-none shadow-sm hover:shadow-md bg-white text-center rounded-2xl">
              <CardContent className="pt-8 pb-6 px-4">
                <div className="w-16 h-16 mx-auto bg-blue-100 rounded-md flex items-center justify-center mb-4 relative">
                  <div className="absolute -top-2 bg-blue-600 text-white text-[10px] uppercase font-bold px-2 py-0.5 rounded-md">
                    Level 2
                  </div>
                ...
                <p className="text-xs text-slate-500 leading-relaxed">
                  Speed vs accuracy balance with intermediate application-based
                  problems.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-none shadow-sm hover:shadow-md bg-white text-center rounded-2xl">
              <CardContent className="pt-8 pb-6 px-4">
                <div className="w-16 h-16 mx-auto bg-red-100 rounded-md flex items-center justify-center mb-4 relative">
                  <div className="absolute -top-2 bg-red-500 text-white text-[10px] uppercase font-bold px-2 py-0.5 rounded-md">
                    Level 3
                  </div>
                ...
                <p className="text-xs text-slate-500 leading-relaxed">
                  Advanced analytical challenges simulating national entrance
                  exams.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-none shadow-xl bg-primary text-white text-center rounded-2xl transform lg:scale-105 border-4 border-white">
              <CardContent className="pt-8 pb-6 px-4">
                <div className="w-16 h-16 mx-auto bg-white/20 rounded-md flex items-center justify-center mb-4 relative">
                  <div className="absolute -top-2 bg-accent text-accent-foreground text-[10px] uppercase font-bold px-2 py-0.5 rounded-md">
                    Level 4
                  </div>
                ...
                <p className="text-xs text-white/80 leading-relaxed">
                  The absolute apex. High pressure scenarios simulating top
                  percentiles.
                </p>
              </CardContent>
            </Card>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <p className="text-sm text-slate-700">
                    ...
                    Individual attention with a personalized study plan based on
                    strong/weak areas.
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <p className="text-sm text-slate-700">
                    ...
                    One-on-one doubt resolution and deep concept deep dives at
                    your own pace.
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <p className="text-sm text-slate-700">
                    ...
                    Adaptive timings for maximum convenience and continuous
                    tracking with progress reports.
                  </p>
                </li>
              </ul>
            </CardContent>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <p className="text-sm text-white/90">
                    ...
                    Peer discussions and competitive environment with a
                    well-structured curricular covering all major subjects.
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-accent shrink-0 mt-0.5" />
                  <p className="text-sm text-white/90">
                    <strong className="text-white">Session Prep:</strong>{" "}
                    Regular tests (Mock, Unit tests) and specialized P.T.P.
                    preparation for Boards/IB exam.
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-accent shrink-0 mt-0.5" />
                  <p className="text-sm text-white/90">
                    <strong className="text-white">Extra Support:</strong>{" "}
                    Dedicated sessions for mental ability enhancement and
                    centralized organized study materials.
                  </p>
                </li>
              </ul>
            </CardContent>
