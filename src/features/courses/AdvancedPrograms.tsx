      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-24">
          ...
          <div className="lg:col-span-2 bg-primary rounded-3xl p-8 md:p-12 text-white relative overflow-hidden shadow-xl">
            <div className="absolute top-0 right-0 w-64 h-64 bg-secondary/20 rounded-md blur-3xl -mr-20 -mt-20"></div>
            <div className="absolute bottom-0 left-0 w-80 h-80 bg-accent/10 rounded-md blur-3xl -ml-20 -mb-20"></div>

            <div className="relative z-10">
              <div className="inline-block bg-accent text-accent-foreground text-xs font-bold px-3 py-1 rounded-md uppercase tracking-wider mb-6">
                Premium Program
              </div>
              ...
              <p className="text-lg text-white/80 max-w-lg mb-10 leading-relaxed font-sans">
                Comprehensive 2-year and 4-year integrated coaching for
                India&apos;s toughest medical and engineering entrance exams.
              </p>
          ...
          <div className="bg-slate-200/50 rounded-3xl p-8 md:p-10 border border-slate-200 shadow-sm flex flex-col justify-center">
            <h4 className="text-2xl font-bold font-heading text-slate-800 mb-3">
              Board Mastery
            </h4>
            <p className="text-slate-600 mb-8 text-sm leading-relaxed">
              Guaranteed CBSE/ICSE/State Board excellence without compromising
              competitive prep.
            </p>
            <ul className="space-y-4 mb-8">
              <li className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
                <div className="font-bold text-slate-800 text-sm mb-1">
                  Weekly Writing Drills
                </div>
                <div className="text-xs text-slate-500">
                  Focusing on clarity & scoring techniques
                </div>
              </li>
              <li className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
                <div className="font-bold text-slate-800 text-sm mb-1">
                  Examiner Grading Review
                </div>
                <div className="text-xs text-slate-500">
                  Evaluation from past board moderators
                </div>
              </li>
            </ul>
            <Button
              variant="outline"
              className="w-full font-bold border-slate-300 bg-transparent text-slate-700 hover:text-primary"
            >
              VIEW SYLLABUS
            </Button>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-6 md:p-8 rounded-3xl border border-slate-200 shadow-md flex flex-col sm:flex-row gap-6 items-center">
            ...
            <div>
              <h4 className="text-2xl font-bold font-heading text-slate-800 mb-2">
                CA Foundation Track
              </h4>
              <p className="text-sm text-slate-600 mb-4 leading-relaxed">
                The ultimate launchpad for aspiring Chartered Accountants with
                dedicated accounts and law focus.
              </p>
          ...
          <div className="bg-white p-6 md:p-8 rounded-3xl border border-slate-200 shadow-md flex flex-col sm:flex-row gap-6 items-center">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600 mb-4 leading-relaxed">
                Strategic entrance preparation for India&apos;s top management
