        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="max-w-2xl animate-fade-in-up">
            ...
            <p className="text-lg text-slate-600 mb-8 leading-relaxed font-sans max-w-xl">
              Rigorous academic framework designed for Grade 5-12. Whether
              it&apos;s the precision of Science or the strategy of Commerce, we
          ...
          <div className="relative animate-scale-in">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-slate-100 aspect-[4/3] border-[6px] border-white">
              <Image
