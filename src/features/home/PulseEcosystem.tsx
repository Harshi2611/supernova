import { Key, Target, Users } from "lucide-react";
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-slate-600 text-lg leading-relaxed">
            Beyond traditional tutoring—we provide a precision-engineered
            learning environment powered by AI and data analytics.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 relative overflow-hidden rounded-[2rem] bg-primary text-white p-10 h-[400px] flex flex-col justify-end shadow-xl group">
            ...
            <div className="relative z-10  flex items-start mb-auto">
              {/* <Brain className="w-6 h-6 text-white" /> */}
              <div className="flex ">
                <h3 className="text-3xl font-bold font-heading mb-4">
                  Std. 1<sup>st</sup> to 10<sup>th</sup>
                </h3>
              </div>
            </div>
            ...
            <div className="relative z-10 max-w-md mt-8">
              ...
              <p className="text-white/80 leading-relaxed text-sm md:text-base">
                Our proprietary algorithm identifies your conceptual gaps in
                real-time, tailoring every mock test to your unique cognitive
                signature.
              </p>
          ...
          {features.map((feat, idx) => (
            <div
              key={idx}
              className={`bg-white border border-slate-200 rounded-[2rem] p-8 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden flex flex-col ${feat.colSpan}`}
            >
